<div class="max-w-5xl mx-auto space-y-6">
    ...
    <x-modal name="flour-deposit" maxWidth="lg">
        <div class="p-6">
            <h2 class="text-lg font-semibold text-gray-800 mb-5">تسجيل استلام قمح جديد</h2>
            <form wire:submit="addDeposit" class="space-y-4">
                ...
                <div class="flex justify-end gap-3">
                    <button type="button" @click="$dispatch('close-modal', 'flour-deposit')" class="px-4 py-2 rounded-xl border border-gray-300 text-sm text-gray-700 hover:bg-gray-50">إلغاء</button>
    ...
    <x-modal name="bread-delivery" maxWidth="lg">
        <div class="p-6">
            <h2 class="text-lg font-semibold text-gray-800 mb-5">تسليم خبز مقابل رصيد القمح</h2>
